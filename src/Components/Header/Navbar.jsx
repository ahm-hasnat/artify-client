...
const Navbar = () => {
  const activeLink = ({ isActive }) => (isActive ? "underline md:text-[#B8860B]" : "md:text-white");

    return (
        <div className="navbar px-4 p-1 bg-gradient-to-r
         from-[#1A3E6F] to-[#2a5298] shadow-sm fixed top-0 z-10">
  <div className="navbar-start">
    ...
    <div className='flex items-center'>
        <span className='text-4xl mr-2 text-[#B8860B]'><FontAwesomeIcon  icon={faBuildingColumns} /></span>
